...
class TemplateBinaryReader : public LynxBinaryReader,
 ...
 public:
  ...
  bool IsLepusngBinary() {
    return context_type_ == lepus::ContextType::LepusNGContextType;
  }
  bool IsRTSBinary() {
    return context_type_ == lepus::ContextType::RTSContextType;
  }
  bool IsRTSNativeBinary() {
    return context_type_ == lepus::ContextType::RTSNativeContextType;
  }
